...
export const MessageActionAdvanced = ({
  ...
  return (
    <form
      className={cx('bg-secondary ring-secondary relative flex h-max flex-col rounded-xl ring-1 ring-inset', className)}
    ...
    >
      ...
      <div className="flex w-full items-center justify-between gap-3 px-3 py-2">
        <div className="flex cursor-pointer items-center gap-1">
          ...
          />
          <div className="flex items-center gap-0.5">
            <p className="text-tertiary truncate text-xs font-semibold">Olivia </p>
            <ChevronDown className="text-fg-quaternary size-3 stroke-3" />
          </div>
        </div>
