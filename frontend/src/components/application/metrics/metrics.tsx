        ...
        <div className={cx("rounded-xl bg-primary shadow-xs ring-1 ring-secondary ring-inset", className)}>
            <div className="relative flex flex-col gap-4 px-4 py-5 md:gap-5 md:px-5">
                <div className="flex items-center gap-3">
                    <FeaturedIcon color="brand" theme="light" size="lg" icon={icon} />
                    <p className="flex-1 text-md font-semibold text-primary">{title}</p>
                </div>

                <p className="max-w-prose text-primary">{description}</p>
            </div>
