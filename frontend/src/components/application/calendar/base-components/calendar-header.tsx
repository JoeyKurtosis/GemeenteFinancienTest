...
export const CalendarHeader = ({
  ...
  const renderPeriod = () => {
    ...
    return <span className="text-tertiary text-sm">{date.toLocaleString(locale, { weekday: 'long' })}</span>
  }

  return (
    <div className="bg-primary relative flex flex-col items-start justify-between gap-4 px-4 py-5 md:px-6 lg:flex-row">
      <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col gap-0.5">
          <div className="text-primary flex items-center gap-2 text-lg font-semibold whitespace-nowrap">
      ...
      <div className="border-secondary pointer-events-none absolute bottom-0 left-0 w-full border-t"></div>
    </div>
  )
}
