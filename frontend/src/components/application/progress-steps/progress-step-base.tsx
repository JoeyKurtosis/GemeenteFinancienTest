  ...
  return (
    <div className={cx('flex w-full flex-col items-center justify-center gap-4', size === 'sm' && 'gap-3')}>
      ...
      <div className={cx('flex w-full flex-col items-start gap-0.5 self-stretch', size === 'sm' && 'gap-0')}>
        ...
        <p className={cx('w-full text-center', statuses[status].description, size === 'sm' ? 'text-sm' : 'text-md')}>
          {description}
        </p>
      </div>
    </div>
    ...
    <div className={cx('group flex h-max flex-row items-start justify-start gap-4', size === 'sm' && 'gap-3')}>
      ...
      <div
        className={cx(
          ...
          size === 'sm' ? 'pt-0.5 not-group-last:pb-6' : 'pt-1 not-group-last:pb-8'
        )}
      >
        <p className={cx(statuses[status].title, size === 'sm' ? 'text-sm font-semibold' : 'text-md font-semibold')}>
          {title}
        </p>
  ...
  return (
    <div className={cx('flex w-full flex-col items-center justify-center gap-4', size === 'sm' && 'gap-3')}>
      ...
      >
        ...
        <p className={cx('text-tertiary w-full text-center', size === 'sm' ? 'text-sm' : 'text-md')}>{description}</p>
      </div>
    </div>
  )
}
  ...
  return (
    <div className={cx('group flex flex-row gap-4', status !== 'current' && 'opacity-60', size === 'sm' && 'gap-3')}>
      <div className="flex flex-col items-center self-stretch">
        ...
        {connector && (
          <span
            className={cx(status === 'current' && 'opacity-60', 'border-secondary my-1 flex-1 rounded-xs border-l-2')}
          />
        )}
      </div>
      <div className="flex flex-col items-start not-group-last:pb-8">
        <p className={cx('text-secondary', size === 'sm' ? 'text-sm font-semibold' : 'text-md font-semibold')}>
          {title}
        </p>
