...
export const AIAssistantModal = () => {
  ...
  return (
    <ModalOverlay isOpen={isOpen} onOpenChange={setIsOpen} isDismissable>
      <Modal>
        <Dialog>
          <div className="bg-primary relative w-full max-w-120 overflow-hidden rounded-2xl shadow-xl">
            <div className="flex flex-col items-center gap-5 px-4 py-6 text-center md:px-6 md:pt-8">
              <Logo />

              <div className="w-full md:max-w-xs">
                <p className="text-md text-quaternary font-semibold md:text-lg">Hi Olivia,</p>
                <AriaHeading slot="title" className="text-md text-primary font-semibold md:text-lg">
            ...
            <div className="flex flex-col px-4 pb-8 md:px-6">
              <div className="flex flex-wrap justify-center gap-2">
                <button className="outline-focus-ring cursor-pointer rounded-md focus-visible:outline-2 focus-visible:outline-offset-2">
