...
const FeaturedIcon = ({
  ...
  return (
    <FeaturedIconbase {...props} {...{ color, theme, icon }} size={!size && rootSize === 'lg' ? 'xl' : size || 'lg'} />
  )
}
...
const Description = (props: ComponentPropsWithRef<'p'>) => {
  ...
  return (
    <p {...props} className={cx('text-tertiary text-center text-sm', size === 'lg' && 'text-md', props.className)} />
  )
}
