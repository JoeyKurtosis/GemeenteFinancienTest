...
import { type BatenBron, fetchBaten } from "../api";
 ...
 * can be shared and survives a reload. They are also the cache key, so the four bron tabs
...
export function useBaten(bron: BatenBron) {
    ...
    return useChartQuery({
        ...
        params: {
            ...
            // Unlike the Benchmark page, these charts read the reservemutaties toggle: it moves
            // baten, and the bijdragen uit reserves it switches on land in the Overige inkomsten
            // bron.
