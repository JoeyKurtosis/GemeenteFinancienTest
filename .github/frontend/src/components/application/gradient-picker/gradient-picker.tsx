...
import { GradientProvider, useGradientColorPicker } from './gradient-picker-context'
...
export const GradientArea = () => {
  ...
  return (
    ...
    >
      <div
        className="ring-alpha-black/10 absolute inset-0 overflow-hidden rounded-lg ring-[0.5px] ring-inset"
      ...
      {sorted.map((stop) => {
        ...
        return (
          <button
            ...
            className={cx(
              'outline-focus-ring absolute z-10 -translate-x-1/2 -translate-y-1/2 cursor-grab rounded-full border-[3px] border-white shadow-md outline-0 focus-visible:outline-2 focus-visible:outline-offset-2 active:cursor-grabbing',
    ...
    >
      {state.gradientStops.map((stop) => (
        <button
          ...
          className="outline-focus-ring absolute top-1/2 size-5 -translate-x-1/2 -translate-y-1/2 cursor-grab rounded-full border-[3px] border-white shadow-md outline-0 focus-visible:outline-2 focus-visible:outline-offset-2 active:cursor-grabbing"
  ...
  return (
    <Dropdown.Root>
      <Button
        size="xs"
        color="link-gray"
        iconTrailing={(props) => <ChevronDown data-icon="trailing" {...props} className="size-3! stroke-[2.5px]!" />}
      >
  ...
  return (
    <InputCell className="w-14 shrink-0 shadow-xs">
      <input
        ...
        className="text-primary w-full bg-transparent px-2.5 py-2 text-sm outline-hidden"
      />
    </InputCell>
  )
}
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-3">
        <p className="text-secondary flex-1 text-sm font-semibold">Stops</p>
...
export const GradientReverseButton = () => {
  ...
  return (
    <ButtonUtility
      ...
      onClick={() => actions.reverseGradient()}
    />
  )
}
