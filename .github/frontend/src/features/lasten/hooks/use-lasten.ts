...
import { type Lasten, type LastenTaakveld, fetchLasten } from "../api";
...
export function useLasten(taakveld: LastenTaakveld) {
    ...
    const [data, setData] = useState<Lasten | null>(null);
    ...
    // These charts read the reservemutaties toggle: it moves the lasten, and the mutaties it
    // switches on are a taakveld of Bestuur en ondersteuning like any other.
    ...
    }, [isReady, taakveld, jaar, verslagsoort, gemeente, referentie, reservemutaties]);
